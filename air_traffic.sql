...
(
  id SERIAL PRIMARY KEY,
  passenger INTEGER REFERENCES passenger ON DELETE CASCADE,
  seat TEXT,
  flight INTEGER REFERENCES flight ON DELETE CASCADE
);
...
VALUES
  ...
  INSERT INTO ticket  (passenger, seat, flight) VALUES
  (1, '33B', 1),
  (2, '8A', 2),
  (3, '12F', 3),
  (1, '20A', 4),
